...
[![nuget](https://img.shields.io/badge/nuget-v1.6.0-FF8821)](https://www.nuget.org/packages/U8XmlParser)
...
git URL: (https://github.com/ikorin24/U8XmlParser.git?path=src/U8XmlParserUnity/Assets/Plugins#v1.6.0)
